...
You cant even find the words. You turn away from {0} to catch your breath.")
...
You're probably more familiar with my cousins, the pixie fairies. But I little something a little more domestic.\
You can think of me as a Tooth Fairy, except instead of giving you money we actually grant wishes\
Someone wished for me to intiate the apocalypse. I have to refuse but if dont grant a tooth bearers wishes I will die a slow and painful death\
You cant even find the words. You turn away from {0} to catch your breath.")

whatisresponse = ("They are waiting for your response.\
A) I dont want you to die. How can I help you?\
B) I need some time to process this foolishness.\
C) This is crazy!! Im out.\
How do you respond? A, B, or C?")

fear = ("{0} says, 'You mean everything to me, if I die and it protects you its worth it!!!'")

clock = ("{0} says, 'Of course, take all the time you need. Just stay inside the house where its safe.'")
